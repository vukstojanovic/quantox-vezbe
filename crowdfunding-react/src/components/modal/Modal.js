...
export default function Modal() {
    ...
    const productsList = [
      {name: "Pledge with no reward", minPledge: null, description: "Choose to support us without a reward if you simply believe in our project. As a backer, you will be signed up to receive product updates via email.", articlesLeft: "N/A", updateArticles: null},
